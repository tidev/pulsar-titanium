...
export default {
    ...
    buildTi() {
        ...
        let args = {};
        const buildOption = this.toolbar.buildSelect.selectedOption().value;
        if (buildOption == 'run') {
            ...
            args = this.toolbar.customBuildOptions.concat(['-d', atom.project.getPaths()[0]]);
        }
