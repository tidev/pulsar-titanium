...
export default {
    ...
    getSuggestions(request) {
      ...
      // if (_.isFunction(completions.sort)) { completions.sort(Utils.completionSort); }
      if (completions != null) {
    ...
    onDidInsertSuggestion({editor, triggerPosition, suggestion}) {
      console.log(suggestion.onDidInsertSuggestion);
    ...
    loadCompletions() {
      this.completions = require('../../include/completions');
