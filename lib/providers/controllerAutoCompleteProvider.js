...
customAlloyCompletionRules = [
  ...
  //
  {
    ...
    getCompletions(request) {
      ...
      let tiCompletions = require('../../include/completions');
          ...
          if (curTagName && tiCompletions.tags[curTagName]) {
            ...
            _.each(tiCompletions.properties[propertyName] != null ? tiCompletions.properties[propertyName].values : undefined, function(value){
              ...
              return completions.push(autoCompleteHelper.suggestion({
                ...
                tagName:  _.contains(curTagObject.properties,propertyName) ? `${curTagName}` : null
                // description: `${apiName} ${propertyName} property`,
                // priority : valueInfo[1]==='deprecated' ? -1 : 2,
                // descriptionMoreURL: Utils.documentationURLForAPI(apiName, propertyName, 'property')
              }));
            });
          }
        }
...
export default {
  ...
  loadCompletions() {
    return this.completions = require('../../include/completions');
  },
          ...
          if (curTagObject) {
            _.each(curTagObject.functions, value=>
              completions.push(autoCompleteHelper.suggestion({
                ...
                apiName,
                value,
                // description: `${apiName} ${value} method`,
                // descriptionMoreURL: Utils.documentationURLForAPI(apiName, value, 'method'),
                priority: 3
              }))
            );
            ...
            _.each(curTagObject.properties, value=>
              completions.push(autoCompleteHelper.suggestion({
                ...
                apiName,
                value,
                // description: `${apiName} ${value} property`,
                // descriptionMoreURL: Utils.documentationURLForAPI(apiName, value, 'property'),
                priority: 3
              }))
            );
          }
