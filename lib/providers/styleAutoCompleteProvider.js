...
module.exports = {
	...
	getPropertyNameCompletions({ bufferPosition, editor, scopeDescriptor, activatedManually }) {
		...
		const type = this.types[this.properties[parentObjName] != null ? this.properties[parentObjName].type : undefined];
		if ((this.properties[parentObjName] != null ? this.properties[parentObjName].type : undefined) && type.properties && type.properties.length) {
