	...
	common: [
		{ // i18n
			...
			targetPath: function(){
				...
				return path.join(Utils.getI18nPath(), atom.config.get('appcelerator-titanium.defaultI18nLanguage'), 'strings.xml');
			},
			didGenerateCallback: function(text){
				const defaultLang = atom.config.get('appcelerator-titanium.defaultI18nLanguage');
