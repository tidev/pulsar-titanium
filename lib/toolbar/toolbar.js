...
export default class ToolBar {
    ...
    constructor () {
        ...
        this.buildSelect.addOptions([{text: 'Run', value: 'run'},
                                     {text: 'Distribute', value: 'dist-adhoc'},
    ...
    enableCodeSigning() {
        ...
        if (target.platform.value == 'ios' && (target.type == 'device' || this.buildOption == 'dist-adhoc')) {
            this.toggleCodeSigningButton.setEnabled(true);
        } else {
            this.toggleCodeSigningButton.setEnabled(false);
            this.hideCodeSigning();
    ...
    get buildOption() {
        return this.buildSelect.selectedOption().value;
    }
    ...
    populateiOSCertificates() {
        ...
        this.certificates = Ti.iosCertificates(this.buildOption == 'run' ? 'developer' : 'distribution');
    ...
    populateiOSProvisioningProfiles() {
        ...
        this.provisioningProfiles = Ti.iosProvisioningProfiles(this.buildOption == 'run' ? 'development' : 'distribution', certificate);
