...
export default class ToolBar {
    ...
    enableCodeSigning() {
        ...
        if (target.platform.value == 'ios' && (target.type == 'device' || this.runOption == 'dist-adhoc')) {
            this.toggleCodeSigningButton.setEnabled(true);
        } else {
            this.toggleCodeSigningButton.setEnabled(false);
            this.hideCodeSigning();
    ...
    populateiOSCertificates() {
        ...
        this.certificates = Appc.iosCertificates(this.runOption == 'run' ? 'developer' : 'distribution');
    ...
    populateiOSProvisioningProfiles() {
        ...
        this.provisioningProfiles = Appc.iosProvisioningProfiles(this.runOption == 'run' ? 'development' : 'distribution', certificate, Tiapp.appId());
