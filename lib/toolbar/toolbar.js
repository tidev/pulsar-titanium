...
export default class ToolBar {
    ...
    constructor () {
        ...
        this.buildButton = this.addButton(this.leftBar, {
            icon: 'play',
            callback: 'appc:run',
            tooltip: 'Build / Stop',
            class: 'button-left'
        ...
        this.simulatorSelect.onChange(function(e){
            if (e.value == 'refresh') {
                this.simulatorSelect.removeOptions();
                Ti.getInfo(function() {
                    console.log(this);
    ...
    populateiOSTargets() {
        ...
        if (this.targets.devices.length == 0) {
            this.simulatorSelect.addOption({text: 'No Device Targets', value: '', disabled: true});
        } else {
        ...
        this.simulatorSelect.addOption({text: '', value: '', disabled: true});
        this.simulatorSelect.addOption({text: '──────────', value: '', disabled: true});
        this.simulatorSelect.addOption({text: 'Refresh Targets', value: 'refresh'});
    }
    ...
    setBuildButtonState(inProgress) {
        if (inProgress) {
