...
export default class Toolbar {
			...
			<div className={this.state.showingCodeSigning || this.state.buildCommand === 'custom' ? 'appc-toolbar toolbar-expanded' : 'appc-toolbar'}>
				...
				<div className="toolbar-row">
					...
					<div className="toolbar-left main-toolbar-group">
						...
						<Button title="Compile" icon="gear" flat="true" disabled={this.state.disableUI || !this.state.codeSigningAvailable} click={this.expandButtonClicked.bind(this)} />
						<Button title="Take screenshot" icon="device-camera" flat="true" disabled={this.state.disableUI} click={this.takeScreenshotButtonClicked.bind(this)}/>
					</div>
	...
	takeScreenshotButtonClicked() {
		atom.commands.dispatch(atom.views.getView(atom.workspace), 'appc:takeScreeshot');
	}
