...
export default class Toolbar {
	...
	constructor() {
		...
		this.state = {
			...
			androidKeystore: {
				path: atom.config.get('appcelerator-titanium.androidKeystore.path') || '',
				alias: '',
				password: '',
				privateKeyPassword: ''
			}
	...
	getState() {
		...
		if (this.refs.androidKeystorePath) {
			...
			atom.config.set('appcelerator-titanium.androidKeystore.path', this.state.androidKeystore.path);
		}
