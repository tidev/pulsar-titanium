...
export default class Toolbar {
				...
				expandedToolbarRow = (
					<div className="toolbar-row">
						...
						<div className="toolbar-right">
							<Button flat="true" icon="x" click={this.expandButtonClick.bind(this)} />
						</div>
					</div>
				);
			} else if (this.state.platform === 'android') {
			...
			<div className={this.state.showingCodeSigning || this.state.buildCommand === 'custom' ? 'appc-toolbar toolbar-expanded' : 'appc-toolbar'}>
				...
				<div className="toolbar-row">
					...
					<div className="toolbar-left main-toolbar-group">
						...
						<Button icon="gear" flat="true" disabled={this.state.disableUI || !this.state.codeSigningAvailable} click={this.expandButtonClick.bind(this)} />
					</div>
	...
	populateWindowsTargets() {
		...
		for (const emulator of this.targets.emulators) {
