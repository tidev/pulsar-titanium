    ...
    render() {
        ...
        if (this.state.showingCodeSigning) {
            if (this.state.platform === 'ios') {
                ...
                codeSigning = (
                    <div className='code-signing'>
                        <div className='toolbar-title icon icon-organization' />
                        ...
                        <div className='toolbar-title icon icon-file' />
                ...
                codeSigning = (
                    <div className='code-signing'>
                        <div className='toolbar-title'>Keystore:</div>
                        <input className='input-text native-key-bindings keystore-input keystore-path-input' ref='androidKeystorePath' value={this.state.androidKeystore.path} on={{change:this.androidKeystoreDidChange}} />
                        <Button flat='true' icon='file-directory' className='button-left' click={this.androidKeystoreButtonClick.bind(this)} />
                        <div className='toolbar-title'>Keystore alias:</div>
                        <input className='input-text native-key-bindings keystore-input' ref='androidKeystoreAlias' value={this.state.androidKeystore.alias} on={{change:this.androidKeystoreDidChange}} />
                        <div className='toolbar-title'>Keystore password:</div>
                        <input type='password' className='input-text native-key-bindings keystore-input' ref='androidKeystorePassword' value={this.state.androidKeystore.password} on={{change:this.androidKeystoreDidChange}} />
                        <div className='toolbar-title'>Private key password:</div>
                        <input type='password' className='input-text native-key-bindings keystore-input' ref='androidKeystorePrivateKeyPassword' value={this.state.androidKeystore.privateKeyPassword} on={{change:this.androidKeystoreDidChange}} />
                    </div>
                )
        ...
        let custom = '';
        if (this.state.buildCommand === 'custom') {

            custom = (
                <div className='code-signing'>
                    <div className='toolbar-title'>Custom args:</div>
                    <input className='input-text native-key-bindings keystore-input keystore-path-input' ref='customArgs' value={this.state.customArgs} attributes={{'placeholder':'args passed to appc run command...'}} on={{change:this.customArgsDidChange}} />
                </div>
            )
        }

		return (
            <div className={this.state.showingCodeSigning || this.state.buildCommand === 'custom' ? 'toolbar-container toolbar-expanded' : 'toolbar-container'}>
                ...
                <div className='toolbar'>
                    ...
                    <div className='left-bar'>
                        ...
                        <div className='element button-left build-button-container'>
                            <Button ref='buildButton' className='button-left build-button' custom='true' icon={buildButtonIcon} disabled={this.state.disableUI} click={this.buildButtonClick.bind(this)} />
